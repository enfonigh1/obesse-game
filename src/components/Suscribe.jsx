...
const Subscribe = () => {
  ...
  return (
    <div className="w-full px-4 md:px-28 mb-10 ">
      <div
        className=" max-w-6xl 2xl:max-w-full 2xl:h-[20vh] h-72 rounded-r-[32px]  2xl:rounded-bl-[68px] 2xl:rounded-br-[50px] relative flex flex-col items-center"
        style={{
      ...
      >
        ...
        <input type="text" className="w-full outline-none rounded-3xl pl-8 pr-24 md:pl-auto md:pr-0 md:px-10 shadow-md font-['Lexend'] text-neutral-400 text-sm 2xl:text-md font-medium leading-snug placeholder:font-['Lexend'] py-2.5 2xl:py-3" placeholder="Your email here"/>

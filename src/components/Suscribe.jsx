...
const Subscribe = () => {
  ...
  return (
    <div className="w-full px-4 md:px-28 mb-10">
      ...
      >
        <img src={img1} className=" absolute w-8 left-2 top-2 md:w-12  lg:w-auto md:left-10 md:top-4" alt="images" />
        <img src={img2} className=" absolute w-8 top-4 md:w-12  lg:w-auto md:left-40 md:top-4 " alt="images" />
        <img src={img3} className=" absolute w-8  md:w-12  lg:w-auto bottom-16 md:bottom-12 lg:bottom-8 left-16" alt="images" />
        <img src={img4} className=" absolute w-8 md:w-12 lg:w-auto bottom-20 left-40 md:bottom-10 lg:bottom-12" alt="images" />
        <img src={img5} className=" absolute w-8 md:w-10 lg:w-auto left-2 md:left-auto top-14 md:top-2 lg:top-14 right-44" alt="images" />
        <img src={img6} className=" absolute w-8 md:w-12 lg:w-auto right-40 bottom-24 md:bottom-12 lg:bottom-12" alt="images" />
        <img src={img7} className="absolute w-8 md:w-12 lg:w-auto right-5 top-16" alt="images" />
        <img src={img8} className=" absolute w-8 md:w-12 lg:w-auto right-20  bottom-10" alt="images" />
